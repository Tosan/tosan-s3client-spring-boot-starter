...
public class S3ClientAutoConfiguration {
    ...
    public SdkHttpClient httpClient(S3ClientProperties properties) {
    ...
    public S3ClientObservationInterceptor observationInterceptor(
            ObservationRegistry observationRegistry,
            @Qualifier("s3ClientLoggerUtil") S3ClientLoggerUtil s3ClientLoggerUtil) {
        return new S3ClientObservationInterceptor(observationRegistry, s3ClientLoggerUtil);
    }
}
